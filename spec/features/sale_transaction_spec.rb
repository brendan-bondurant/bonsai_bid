...
feature 'Transaction History Features' do
  ...
  scenario 'Authenticated user views their own transaction history' do
    sign_in user
    create_list(:sale_transaction, 3, seller: user, buyer: other_user, auction: auction)
    create_list(:sale_transaction, 2, seller: other_user, buyer: user, auction: auction)
  ...
  scenario 'Authenticated user views another user\'s transaction history' do
    sign_in other_user
    create_list(:sale_transaction, 2, buyer: user, seller: other_user, auction: auction)
    create_list(:sale_transaction, 2, seller: user, buyer: other_user, auction: auction)
  ...
  scenario 'Unauthenticated user attempts to view a user\'s transaction history' do
    create_list(:sale_transaction, 4, buyer: user, seller: other_user, auction: auction)
  ...
  scenario 'User views feedback for a transaction' do
    sign_in user
    sale_transaction = create(:sale_transaction, buyer: user, seller: other_user, auction: auction)
