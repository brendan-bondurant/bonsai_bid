...
feature 'Dashboard - User Items and watchlist' do
  scenario 'User views listed and watched items on dashboard' do
    user = User.create!(email: "test@test.com", password: "password", name: "test", address: 'test street', phone: 9876543212 )      
    other_user = User.create!(email: "othertest@othertest.com", password: "password", name: "othertest", address: 'other street', phone: 9879873212 )  
